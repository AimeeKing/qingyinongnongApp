package com.example.hdu.qingyinongnong.view;
 ...
 */
    public class CustomProgressBar extends View {
        ...
        public CustomProgressBar(Context context, AttributeSet attrs,
            ...
            try {
                bodercolor = a.getColor(R.styleable.CustomProgressBar_progressBoderColor,
                ...
                mBorderWidth = (int) a.getDimension(
                        R.styleable.CustomProgressBar_bordWidth,
        ...
        private void drawBorder(Canvas canvas) {
            ...
            mPaint.reset();
            mPaint.setStyle(Paint.Style.FILL_AND_STROKE);//原来是STOKE
