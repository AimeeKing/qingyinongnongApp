...
public class CrowdAllFragment extends Fragment {
    ...
    public static CrowdAllFragment newInstance(int param1) {
        CrowdAllFragment fragment = new CrowdAllFragment();
